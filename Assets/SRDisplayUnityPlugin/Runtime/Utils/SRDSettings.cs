...
namespace SRD.Utils
{
    internal partial class SRDSettings
    {
        ...
        public class SRDDeviceInfo
        {
            ...
            {
                if (SRDCorePlugin.GetTargetMonitorRectangle(out var rect) != SrdXrResult.SUCCESS)
                {
                    return null;
                }
            ...
            {
                if (SRDCorePlugin.GetDisplaySpec(out var spec) != SrdXrResult.SUCCESS)
                {
                    return null;
                }
        ...
        {
            public static readonly float DefaultWidth = 0.3442176f;
            public static readonly float DefaultHeight = 0.1369117f;
            public static readonly float DefaultDepth = 0.1369117f;
