...
namespace GLTFast
{
    ...
    {
        /// <summary>
        /// echo3D added classes and functions
        /// </summary>
        /// 

        // object Instance ID, entryID
        public class ModelAssetLoadedEvent : UnityEvent<int, string>
        {
        }
        public ModelAssetLoadedEvent OnAssetInstantiated = new ModelAssetLoadedEvent();
        ...
        public bool Instantiate(ICodeLogger logger = null, bool zeroTransform = false)
        {
            ...
            if (success)
            {
                OnAssetInstantiated.Invoke(objectId, entryId);
            }
            return success;
        }
