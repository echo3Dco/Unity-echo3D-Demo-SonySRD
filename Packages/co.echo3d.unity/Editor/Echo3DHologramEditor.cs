...
public class Echo3DHologramEditor : Editor
{
    ...
    SerializedProperty onAssetLoaded;
    //SerializedProperty onAssetInit;
    ...
    void OnEnable()
    {
        ...
        onAssetLoaded = serializedObject.FindProperty("onAssetLoaded");
        //onAssetInit = serializedObject.FindProperty("onAssetInit");
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.PropertyField(onAssetLoaded);
        //EditorGUILayout.PropertyField(onAssetInit);
